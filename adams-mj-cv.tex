...
\begin{itemize}
  \item Conducted landmark ($N > 5$ million) genome-wide association study of depression, improving prediction accuracy and identifying mechanisms and drug targets.
  \item Develops computational pipelines for reproducible genomics and biomarker analyses.
  \item Combined psychometric and genetic modelling to understand depression symptoms and primate personality.
  \item Applied indirect genetic effects models to multilevel systems in behavioural ecology.
\end{itemize}

\subsection*{The development of others and maintenance of effective working relationships}

\begin{itemize}
  \item Coordinates work among dozens of analysts in an international consortium.
  \item Co-leads special interest group in depression heterogeneity.
  \item Mentored research students in the creation of a peer support group for coding and data analysis.
\end{itemize}

\subsection*{Contributions to the wider research and innovation community and to societal benefit}

\begin{itemize}
  \item Established and maintains open source repository for the Psychiatric Genomics Consortium.
  \item Engages regularly with lived-experience advisors.
  \item Facilites researcher access to international consortium datasets.
\end{itemize}
...
2026--2031 & MRC. \emph{Longitudinal Population Studies (LPS): Generation Scotland}. (APP86641). £1,780,660. (Co-I) \\ \\

2025--2030 & MRC. \emph{The Mental Health Goals Omics Project (MHG Omics): A UK Multi-Omics Infrastructure and Resource for Mood Disorders}. (APP98537). £8,726,598 [£465,190]. (Co-I) \\ \\
  
2025--2029 & Wellcome Trust. \emph{What is the molecular genetic basis of anxiety in a very-low-income African setting? The Genetics of Anxiety In Malawi (G-AIM) Study}. (309744/Z/24/Z) £2,133,025 [£767,640]. (Co-I) \\ \\
